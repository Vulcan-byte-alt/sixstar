...
for i, prompt in enumerate(prompts, start=1):
    ...
    # Generate image using DALL·E 3 (ChatGPT)
    ...
    filename = re.sub(r"[^a-zA-Z0-9]+", "_", prompt[:50])
...
print("\n🎉 All cruise destination images generated successfully!")
